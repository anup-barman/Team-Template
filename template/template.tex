...
\newcommand{\teamName}{AnupBarman}
\newcommand{\firstMember}{\color{specialist}khun\_}
\newcommand{\secondMember}{\color{pupil}tasnim07}
\newcommand{\thirdMember}{\color{pupil}kazi\_amir}
...
\newcommand{\maketeampage}{
	...
	\begin{center}
		...
		\vspace{2cm}
		{\fontsize{24}{30} \fontfamily{lmss} \selectfont {Personal Reference Document}}\\
		\vspace{1cm}
		\vspace{1cm}
	\end{center}
	\clearpage
